        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          <div>
            ...
            <p className="text-gray-400 mb-2">
              Blonde & Color specialist. Care Coach Kérastase
            </p>
          ...
          <div>
            ...
            <div className="space-y-4 text-gray-400">
              ...
              <p className="flex flex-col">
                ...
                <a href="mailto:prestigeparrucchieri@gmail.com" className="hover:text-gold transition-colors">prestigeparrucchieri@gmail.com</a>
              </p>
            </div>
          </div>
        </div>
