...
const Footer: React.FC = () => {
  return (
    <footer className="bg-brand border-t border-gray-800 mt-16">
      <div className="container mx-auto px-4 md:px-8 py-12">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          <div>
            <h4 className="text-2xl font-heading mb-4 text-white">IL SALONE</h4>
          ...
          <div>
            ...
            <div className="space-y-4 text-gray-400">
              <p className="flex flex-col">
                ...
                <span>Viale M. Buonarroti, 7</span>
                <span>24047 Treviglio BG</span>
              </p>
              <p className="flex flex-col">
                <span className="text-gold mb-1">Telefono</span>
                <a href="tel:320635296" className="hover:text-gold transition-colors">320 635 2936</a>
              </p>
              <p className="flex flex-col">
                <span className="text-gold mb-1">Email</span>
                <a href="mailto:info@ilsalone.it" className="hover:text-gold transition-colors">info@ilsalone.it</a>
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="border-t border-gray-800 mt-10 pt-6 text-gray-500 text-sm flex flex-col md:flex-row justify-between items-center">
          <p>© 2025 IL SALONE. Tutti i diritti riservati.</p>
