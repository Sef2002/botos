        ...
        <div className="container mx-auto px-4 md:px-8 relative z-10">
          <div className="max-w-4xl">
            <h1 className="text-5xl sm:text-6xl md:text-7xl font-heading font-bold mb-4 fade-in" style={{ '--delay': '100ms' } as React.CSSProperties}>
              MADAME<br />
              <span className="text-gold">ACCONCIATURE</span>
            </h1>
            <p className="text-lg sm:text-xl text-gray-300 mb-6 max-w-2xl fade-in" style={{ '--delay': '200ms' } as React.CSSProperties}>
              Innovazione e creatività nel cuore di Treviglio. Madame e il suo team ti offrono un'esperienza unica con i migliori prodotti e le tecniche più avanzate.
            </p>
            <div className="flex items-center gap-6 mb-8 fade-in" style={{ '--delay': '250ms' } as React.CSSProperties}>
              <div className="flex items-center gap-2 text-gold">
                <MapPin size={18} />
                <span className="text-sm">Viale XXIV Maggio, 23D - Treviglio</span>
              </div>
              <div className="flex items-center gap-2 text-gold">
                <Clock size={18} />
                <span className="text-sm">Nel cuore di Treviglio</span>
              </div>
            </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
            <div className="fade-in">
              ...
              <div className="space-y-6 text-gray-600 font-primary leading-relaxed">
                <p>
                  Madame Acconciature sorge in Viale XXIV Maggio 23D a Treviglio, nel cuore della città, facilmente raggiungibile da ogni zona.
                </p>
                <p>
                  Madame, la titolare, insieme al suo intero staff si prende cura con amore e dedizione della sua clientela proponendo servizi innovativi e creativi, colori alla moda e tagli che seguono sempre gli ultimi trend.
                </p>
                <p>
            ...
            <div className="grid grid-cols-2 gap-4 fade-in">
              <div className="space-y-4">
                <img 
                  ...
                  alt="Madame Acconciature - Ambiente elegante" 
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4 fade-in">
            <div className="col-span-2 row-span-2">
              <img 
                ...
                alt="Madame Acconciature - Lavoro professionale" 
        ...
        <div className="container mx-auto px-4 md:px-8 relative z-10 text-center">
          <div className="max-w-2xl mx-auto fade-in">
            ...
            <p className="text-lg text-gray-300 mb-8">
              Affidati all'esperienza di Madame e del suo team. Prenota ora per un'esperienza di bellezza unica nel cuore di Treviglio.
            </p>
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <Link to="/prenota/servizio" className="btn btn-primary text-lg px-8 py-3">PRENOTA ORA</Link>
              <a href="tel:3514460171" className="btn btn-outline text-lg px-8 py-3">CHIAMA ORA</a>
            </div>
          </div>
        </div>
      </section>
