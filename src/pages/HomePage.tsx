    ...
    <main>
      ...
      <section className="h-screen relative flex items-center">
        ...
        <div className="container mx-auto px-4 md:px-8 relative z-10">
          <div className="max-w-3xl">
            <h1 className="text-5xl sm:text-6xl md:text-7xl font-heading font-bold mb-2 fade-in text-white whitespace-nowrap" style={{ '--delay': '100ms' } as React.CSSProperties}>
              IL SALONE DI LISA
            </h1>
      ...
      <section className="py-20 bg-white">
        <div className="container mx-auto px-4 md:px-8">
          ...
          <div className="text-center mt-12 fade-in">
            <Link to="/servizi" className="btn btn-outline border-[#5e3a1e] text-[#5e3a1e] hover:bg-[#5e3a1e] hover:text-white transition-colors">
      ...
      >
        <div className="container mx-auto px-4 md:px-8">
          ...
          <div className="text-center mt-12 fade-in">
            <Link to="/galleria" className="btn btn-outline border-[#5e3a1e] text-[#5e3a1e] hover:bg-[#5e3a1e] hover:text-white transition-colors">
              SFOGLIA LA GALLERIA
            </Link>
          </div>
        </div>
